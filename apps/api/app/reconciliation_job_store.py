"""SQLite persistence for reconciliation background submissions."""
...
class SQLiteReconciliationJobStore:
    ...
    def submission(self, job_id: UUID) -> ReconciliationJobSubmission | None:
        ...
        return ReconciliationJobSubmission.model_validate_json(row["request_json"]) if row else None
